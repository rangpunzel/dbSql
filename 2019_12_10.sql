...
--emp 테이블에서 KING 데이터 삭제 후 v_emp_dept view 조회 결과 확인
SELECT *
FROM v_emp_dept;
...
--실행 계획을 통해 7369 사번을 갖는 직원 정보를 조회 하기 위해
--테이블의 모든 데이터(14)를 읽어 본 다음에 사번이 7369인 데이터만 선택하여
--사용자에게 반환
